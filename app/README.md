...
- **短期记忆**：最近 5 轮对话 + 实体追踪 + 历史摘要，可通过前端面板查看
...
| Agent 思考过程 | 折叠面板，展示意图识别、召回、Rerank、推理详情 |
...
| LLM 生成   | Qwen (qwen36-27b)      | 本地部署，OpenAI 兼容 API |
| LLM 改写   | Qwen (qwen36_27b_lora) | 本地部署，微调模型        |
